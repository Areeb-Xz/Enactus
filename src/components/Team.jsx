    ...
    <>
      ...
      <section className="w-full flex flex-col items-center text-center py-12 px-6 md:py-16">
        ...
        <p className="mt-2 md:mt-4 max-w-2xl text-md sm:text-lg text-gray-500 px-2 md:px-0">
          We are Enactus York, a student-led club that is part of the global Enactus network. Our mission is to empower students to create meaningful impact through entrepreneurship. We encourage students to share their innovative ideas and provide the support, resources, and guidance needed to turn those ideas into reality.
        </p>
      </section>

      {/* Our Story Box with Grid */}
...
/>
          ...
          <div className="relative flex-1 flex items-center justify-center px-6 md:px-12 py-10">
            ...
            <div className="text-black max-w-lg">
              ...
              <p className="text-base sm:text-lg leading-relaxed">
                This club was revitalized in 2024 by <span className="font-semibold">Parmeet Singh</span>, who envisioned creating a strong platform to promote entrepreneurship among students. Through his dedication and consistent efforts, he built a passionate team of 15 members. Today, the club is driving three active projects and is led by Co-Presidents <span className="font-semibold">Parmeet Singh</span> and <span className="font-semibold">Prabhkrit Singh</span> with <span className="font-semibold">Mohammad Areeb</span> serving as Vice President to support and strengthen its operations. As a team, Enactus has actively participated in several competitions and hackathons, achieving multiple victories that highlight the dedication and excellence of our club.
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 z-10 flex items-center justify-center p-6">
            <img 
              src="src/assets/PHOTO-2025-09-17-01-12-51.jpg" // Replace with real image
              alt="Our Story"
